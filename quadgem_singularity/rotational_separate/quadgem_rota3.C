...
//   filename = Form("./OUTFILE/chevrdo_rdoxite_quadgem350_expcld1_5_40um300c_%s.root", argv[1]);
   filename = Form("OUTFILE/quadgem_gemout_73ArCo2_350dv_itlay_3_%s.root", argv[1]);
  ...
  */
  ...
  fileinp = Form("OUTFILE/quadgem_gemout_73ArCo2_350dv_itlay_2_%s.root", argv[1]);
  //
